...
libcall_info_t Gdi32_info[] = {
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hPal", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{ "BitBlt",9,
	{
		...
		{5, "hdcSrc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{ "ColorCorrectPalette",4,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "hPal", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{ "ColorMatchToTarget",3,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "hdcTarget", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hrgnDst", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "hrgnSrc1", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{2, "hrgnSrc2", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, OUT },
		{0, "hEnh", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, OUT },
		{0, "pbm", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagBITMAP", 256, UNK },
	}
	},
	{ "CreateBrushIndirect",1,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, OUT },
		{0, "plbrush", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagLOGBRUSH", 128, UNK },
	}
	},
	{ "CreateColorSpaceA",1,
	{
	...
	{ "CreateDIBSection",6,
	{
		...
		{4, "hSection", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, OUT },
		{0, "hbm", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	{ "CreatePen",3,
	{
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hcs", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	{ "DeleteDC",1,
	{
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hmf", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	{ "DeleteMetaFile",1,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hmf", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	}
	},
	{ "DeleteObject",1,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "ho", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	...
	{ "EnumEnhMetaFile",5,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "hmf", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{ "EnumICMProfilesA",3,
	{
		...
		{2, "param", NKT_DBFUNDTYPE_SignedQuadWord, 0, 8, UNK },
	}
	},
	{ "EnumICMProfilesW",3,
	{
	...
	{ "EnumMetaFile",4,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "hmf", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{2, "proc", NKT_DBOBJCLASS_Typedef, 0, 0, UNK },
		{3, "param", NKT_DBFUNDTYPE_SignedQuadWord, 0, 8, UNK },
	}
	},
	{ "EnumObjects",4,
	{
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hrgn1", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "hrgn2", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	{ "Escape",5,
	{
	...
	{ "ExtCreatePen",5,
	{
		...
		{2, "plbrush", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagLOGBRUSH", 128, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdcDest", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdcDest", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		...
		{5, "hdcSrc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hbit", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{ "GetCharacterPlacementA",6,
	{
		...
		{4, "lpResults", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagGCP_RESULTSA", 512, INOUT },
	...
	{ "GetCharacterPlacementW",6,
	{
		...
		{2, "nCount", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, IN },
		{3, "nMexExtent", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, UNK },
		{4, "lpResults", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagGCP_RESULTSW", 512, INOUT },
		{5, "dwFlags", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, IN },
	}
	},
	{ "GetCharWidth32A",4,
	...
	{ "GetDIBits",7,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "hbm", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, OUT },
		{0, "hEMF", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "nSize", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, OUT },
		{0, "hemf", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hColorSpace", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, OUT },
		{0, "h", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	}
	},
	{ "GetObjectW",3,
	{
	...
	{ "GetOutlineTextMetricsA",3,
	{
		...
		{2, "potm", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "_OUTLINETEXTMETRICA", 1856, UNK },
	}
	},
	{ "GetOutlineTextMetricsW",3,
	{
		...
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "cjCopy", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, UNK },
		{2, "potm", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "_OUTLINETEXTMETRICW", 1856, UNK },
	}
	},
	{ "GetPaletteEntries",4,
	{
	...
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, OUT },
		{0, "hrgn", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{ "GetWinMetaFileBits",5,
	{
		...
		{4, "hdcRef", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	}
	},
	{ "GetWorldTransform",2,
	{
	...
	{ "LineDDA",6,
	{
		...
		{5, "data", NKT_DBFUNDTYPE_SignedQuadWord, 0, 8, UNK },
	}
	},
	{ "LineTo",3,
	{
	...
	{ "MaskBlt",12,
	{
		...
		{8, "hbmMask", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{ "PlayEnhMetaFileRecord",4,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "pht", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagHANDLETABLE", 64, UNK },
	...
	{ "PlayMetaFileRecord",4,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "lpHandleTable", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagHANDLETABLE", 64, IN },
	...
	{ "PlgBlt",10,
	{
		...
		{2, "hdcSrc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		...
		{7, "hbmMask", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
	...
	{ "PolyTextOutA",3,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "ppt", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagPOLYTEXTA", 448, UNK },
	...
	{ "PolyTextOutW",3,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "ppt", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagPOLYTEXTW", 448, UNK },
		{2, "nstrings", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, UNK },
	}
	},
	{ "PtInRegion",3,
	...
	{ "SelectObject",2,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{1, "h", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	{ "SelectPalette",3,
	{
	...
	{ "SetColorSpace",2,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "hcs", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
	}
	},
	{ "SetDCBrushColor",2,
	{
	...
	{ "SetWinMetaFileBits",4,
	{
		...
		{2, "hdcRef", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, IN },
		{3, "lpMFP", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "tagMETAFILEPICT", 192, IN },
	}
	},
	{ "SetWorldTransform",2,
	{
	...
	{ "StartDocA",2,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "lpdi", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "_DOCINFOA", 320, UNK },
	}
	},
	{ "StartDocW",2,
	{
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, OUT },
		{0, "hdc", NKT_DBFUNDTYPE_UnsignedQuadWord, 0, 8, UNK },
		{1, "lpdi", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "_DOCINFOW", 320, UNK },
	}
	},
	{ "StartPage",1,
	{
